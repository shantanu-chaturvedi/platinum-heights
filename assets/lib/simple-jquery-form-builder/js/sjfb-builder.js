...
$(function(){
    ...
    $("#add-field a").click(function() {
        ...
        //if($(this).attr("id") != "add-comparision-grid"){
...
function addField(fieldType) {
    ...
    switch (fieldType) {
        case 'text':
            hasRequired = true;
            hasChoices = false;
            fieldCustomName = "Short Answer";
            break;
        case 'textarea':
            hasRequired = true;
            hasChoices = false;
            fieldCustomName = "Paragraph";
            break;
        case 'select':
            hasRequired = true;
            hasChoices = true;
            fieldCustomName = "Select Box";
            break;
        case 'radio':
            hasRequired = true;
            hasChoices = true;
            fieldCustomName = "Single Choice";
            break;
        case 'checkbox':
            hasRequired = false;
            hasChoices = true;
            fieldCustomName = "Multiple Choice";
            break;
        case 'agree':
        ...
        case 'grid':
            hasRequired = false;
            hasChoices = false;
            fieldCustomName = "Comparision Grid";
            break;
    }
    ...
    if(fieldType == 'grid'){
        ...
        '<h3>' + fieldCustomName + '</h3>' +
        '<a href="downloads.php?inventory">Download Inventory Excel <small>(Add Items for the curresponding locations)</small></a>' +
        '<label class="control-label center-block"><strong>Upload Inventory file</strong></label>' + 
        '<form id="projectCreate2" method="POST" enctype="multipart/form-data">' +
