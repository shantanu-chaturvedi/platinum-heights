    ...
    <div class="emailcontent inboxcontent">
      <div class="email-options">
        <div class="settings">
          ...
          <a href="" class="tooltips" onClick="deleteMessageSent(event);" data-toggle="tooltip" data-placement="bottom" title="Move to Trash"><i class="fa fa-trash"></i></a>
      ...
      <?php $messages = getSentMessges($_SESSION['logged_in_userid'],$_SESSION['logged_in_user_role']);
      foreach($messages as $message){?>
        <div class="list-group">
          <div class="list-group-item <?php if($message['unread'] == 1){ echo 'unread'; }?>">
            ...
            <div class="media sentmsg-media" id="<?php echo $message['ID'];?>">
            <?php if($message['receiver_member_type'] == 1){
                  $tblname = 'tbl_admin';
                  $pic = 'profile_pic';
                }else if($message['receiver_member_type'] == 2){
                ...
                $receiverInfos = getNameById($tblname,$message['receiver']);
                foreach($receiverInfos as $receiverInfo){?>
                  <div class="media-left">
                    <img class="media-object img-circle" src="<?php if($data['profile_pic'] == ""){ echo '../assets/images/photos/sampleUserImage.png'; } else{ echo '../view/images/'.$receiverInfo[$pic]; }?>" alt="">
                  </div>
                  <div class="media-body">
                    <span class="pull-right"><?php $date = date_create($message['created_at']);
                              echo date_format($date,"d M, Y");?></span>
                    <h5 class="media-heading">
                      <?php if($receiverInfo['sender_member_type'] == 1){
