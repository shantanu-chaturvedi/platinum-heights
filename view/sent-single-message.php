...
foreach ($datas as $data){?>
  <div class="mailcontent">
    <div class="email-header">
      ...
      <?php if($data['receiver_member_type'] == 1){
          $tblname = 'tbl_admin';
            $pic = 'profile_pic';
        ...
        $receiverInfos = getNameById($tblname,$data['sender']);
        foreach($receiverInfos as $receiverInfo){?>
          ...
          <div class="pull-right">
            ...
            <?php $sender_member_type = $data['sender_member_type'];
            $receiver_member_type = $data['receiver_member_type'];
            $sender = $data['sender'];?>
              <?php if($_SESSION['logged_in_user_role'] == 1){ ?>
                <button class="btn btn-default" type="button" onClick="composeMessage('<?php echo $receiver_member_type?>','<?php echo $receiver_member_type?>','<?php echo $sender?>','<?php echo $subject?>');"><i class="fa fa-reply"></i></button>
              <?php }else{?>
